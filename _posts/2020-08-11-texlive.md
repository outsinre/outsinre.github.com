...
For changes under TEXMFLOCAL, we should update the search path for Kpathsea, as TEXMFLOCAL is prefixed with double `!!` (check _texmf.cnf_ for details).
...
2. You can also use_texhash_ as it is just a symlink to _mktexlsr_.
