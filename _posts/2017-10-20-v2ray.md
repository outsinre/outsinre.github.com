	...
	"settings": {
	    "vnext": [
		{
		    ...
		    "users": [
			{
			    ...
			    "level": 0,
			    "security": "none" // 'none | auto'. As TLS encryption is adopted, extra encryption on Vmess is unnecessary.
			}
		    ]
		}
	    ]
...
3. Don't use V2ray do confidential communication (i.e. email login).
