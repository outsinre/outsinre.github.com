...
2. To share values among jobs, please try the following methods.
   1. Use [GITHUB\_OUTPUT](https://docs.github.com/en/actions/using-jobs/defining-outputs-for-jobs). It is a GHA feature. We can access to such variables only with GHA syntax.
