...
4. Existing key user ID (comment included) can *not* be modified after creation. But you can add or delete user ID instead. We can optionally set one of the user IDs as the *primary* ID (top in the ID list).
