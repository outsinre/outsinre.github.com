...
```
PS C:\Users\jim> Get-AppxPackage    # list full list
PS C:\Users\jim> Get-AppxPackage | Select-String -Pattern "wechat"
PS C:\Users\jim> Get-AppxPackage | Select-String -Pattern "windowscommunicationsapps"   # Mail and Calender
```
