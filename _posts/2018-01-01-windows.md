...
About Office, if you happened to install a retail version (i.e. Office 16 Pro Plus retail), there exists [a script](https://forums.mydigitallife.net/threads/office-2016-retail-to-vl-a-manual.65616/) to help you convert the retail version to VOL version. If you have tried to input different MAK keys before the conversion, you should first remove them before KMS activation.
