...
*slmgr* is for Windows OS and usually resides in the *system32* directory. *ospp.vbs* is for Office 2010/2013/2016. To use it, we should first change the current directory Office's installation. *slmgr* and *cscript ospp.vbs* without parameters print help message.
...
There exist some inofficial GVLKs for retail licensing Windows, which can be found in *vlmcsd.8* man page. Hence, why not attempt to convert Windows to a KMS client as stated above?
