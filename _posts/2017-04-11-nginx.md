...
Here is a sampke skeleton of Context:
...
2. Modular configuration. Different configuration files or directories can be integrated into _nginx.conf_ by the _include_ directive. Here is the common list of configuration modules.
   1. sites-available
