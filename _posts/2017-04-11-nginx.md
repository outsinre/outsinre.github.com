...
4. If none of the modifiers are provided, we call it _prefix_ match.

The match order is as the following:

1. Firstly, do `=` match. If matched, terminate the search.
2. Secondly, do *longest prefix* match. Nginx searches the *longest* `uri` prefix, irrespective of _location_ context order.
