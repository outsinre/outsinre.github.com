...
A general _location_ context is defined as `location optional_modifier uri { }`. Nginx tests the *normilized* request line `request_uri`, namely variable [$uri](https://stackoverflow.com/a/48709976) against *uri* of location contexts.

Put it simple: test location *uri* against variable `$uri`.
