...
6. The first time you flashing TWRP, it asks to mount */system* as read & wirte. You should also select to *never prompt this warning again*. Otherwise TWRP will be overriden by stock recovery.

   The next time you enter TWRP, it asks again (may be a bug) same warning which can be ignored.
# Tips
