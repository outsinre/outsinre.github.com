...
>Let's Encrypt certificate expires in 3 months. Please remember to renew. We can use *crontab* or *systemd* timer to automate certificate renewal.
...
We are approaching the final goal: connect to the relay in browser or Android app.
