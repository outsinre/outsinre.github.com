...
2. [luarocks make](https://github.com/luarocks/luarocks/wiki/make) differs from *luarocks build* in that it compiles Binary Rock or Pure-Lua Rock from the source code in local dev environment. This is very useful when when we want to debug the code.
