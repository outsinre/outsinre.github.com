...
However, [due to a macOS bug](https://github.com/lima-vm/lima/issues/2789), the memory ballooning does not work with `vmType: vz`. If the macOS experiences performance issue, reduce the memory size or restart colima.
