...
According to the [FAQ](https://github.com/abiosoft/colima/blob/main/docs/FAQ.md#how-does-colima-compare-to-minikube-kind-k3d), colima Kubernetes does not support multiple clusters! But we can run Minikube, Kind or K3d with colima as the backend.
