...
By default, the user home directory and `/tmp/colima` are bind mounted to the VM. Check the `mounts` field in the [config file](#config-colima) to [mount other pathnames](https://github.com/abiosoft/colima/blob/main/docs/FAQ.md#issue-with-docker-bind-mount-showing-empty).
...
If the Kubernetes has been enabled. We can dynamically enable and disable afterwards.
...
INFO[0000] socket: unix:///Users/zachary/.colima/default/docker.sock
