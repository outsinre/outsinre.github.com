...
We can customize k3s via the ['k3sArgs' config field](#config-colima). By default, `--disable=traefik` (Ingress controller) is passed the [k3s server](https://docs.k3s.io/cli).
