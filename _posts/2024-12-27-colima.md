...
The default resources assigned to the Linux VM is 2 CPUs, 2 GiB memory and 100 GiB disk space. We want to increase the CPU and memory a bit. Additionally, we want to update more fields as follows. Especially, we enabled [Kubernetes support](#kubernetes-cli-setup).
