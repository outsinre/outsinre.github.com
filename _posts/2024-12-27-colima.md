...
Check the `mounts` field in the [config file](#config-colima) to [mount other pathnames](https://github.com/abiosoft/colima/blob/main/docs/FAQ.md#issue-with-docker-bind-mount-showing-empty). Otherwise, we would receive the error as follows.
