...
We find 6 containers created for different Kubernetes components (e.g. CoreDNS Cluster DNS).
...
With the [default runtime](#introduction), colima and K3s share container images!
